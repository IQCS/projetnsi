...
if __name__ == '__main__':
    def dossier():
        os.chdir(r"C:\Users\NSI-SNT\Documents")

    dossier()

import Yomanga as YM
import Mangascan as MS


path = r"C:\Users\NSI-SNT\Documents\wsm"
...
class Site:
    ...
    def Navigate(self):
        ...
        if 'scan-vf' in self.url:
            [self.soup,self.ListeLiens] = YM.Navigate(self.url)
